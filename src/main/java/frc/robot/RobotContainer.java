...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    // TODO;could use commands and parallel comand groups to simulate turining for
    // the kitbot
 ...
 driverController.a().whileTrue(
    ...
    // value)
    driveSubsystem.setDefaultCommand(driveSubsystem.driveArcade(driveSubsystem,
    ...
    rollerSubsystem.setDefaultCommand(new RunCommand(
        () -> rollerSubsystem.runRoller(
            driverController.getRightTriggerAxis() * rollerSubsystem.rollerScaleFactor(),
            driverController.getLeftTriggerAxis() * rollerSubsystem.rollerScaleFactor()),
        rollerSubsystem));
  }
